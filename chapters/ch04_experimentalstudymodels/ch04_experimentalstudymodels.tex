\chapter{Investigating the drag of model vs. natural trees}
...
\lettrine[lines=3,nindent=0em,loversize=0.1]{I}{n} this chapter, the drag forces and flow fields for model and natural trees are studied. Futhermore, the study aims at providing the basis for a more rigorous model to natural tree comparison. The flow field and drag coefficient of model trees are compared to the ones of natural trees of similar size to determine whether model trees can be used to represent natural trees. Thereafter, the drag coefficient of small model trees and natural trees are compared with the ones measured on larger natural trees in literature. The goal of the present study is to determine how the sheltering provided by small model trees differs from that of small natural trees. Furthermore, the season foliage density change of natural trees is not reflected in the drag coefficient. Therefore, the paper also studies how the seasonal foliage density change of a natural tree impacts the drag coefficient and subsequently the flow field in the wake.
