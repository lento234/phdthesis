\chapter{Comparison of wind tunnel measurement and CFD of a small plant}
...
\subsection{Numerical domain}
	...
	\begin{figure}[t]
		\centering
		\includegraphics[width=0.8\textwidth]{\figdir/WT_CFD_comparison_setup.png}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.8\textwidth]{\figdir/inletBoundaryCondition_v2-crop.pdf}
	\caption{Vertical profiles of incoming normalized \subfig{a} mean streamwise velocity $\overline{u}/U_h$ and  \subfig{b} turbulent kinetic energy $k/U_h^2$ : (black) PIV profile from wind tunnel and (red) CFD boundary condition.}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=\textwidth]{\figdir/LAD_constvsvarying_v2-crop.pdf}
...
\ctable[
	...
	pos = !h,]{lrrr}{}{
\FL
	period		& \multicolumn{2}{c}{experimental} 	& numerical \\
				&  mean 	& max.					&
