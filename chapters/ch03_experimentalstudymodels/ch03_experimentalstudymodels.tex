...
\lettrine[lines=3,nindent=0em,loversize=0.1]{T}{his} chapter focuses on assessing the impact of vegetation on the airflow from experimental observation. \highlight{The hygrothermal influence of vegetation such as the impact of plant transpiration on the atmosphere experimentally studies in the next chapter, \cref{ch:microclimatestudy}. In this chapter, we simply focus on the aerodynamic influence of plant foliage on the airflow. More specifically, we investigate how the various drag coefficient, plant porosity, and foliage flexibility influence the wake velocity statistics. The objective of the present chapter is to obtain insight into the aerodynamic influence of vegetation.}
