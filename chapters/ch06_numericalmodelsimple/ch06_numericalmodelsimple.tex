...
\item Repeat steps (1) to (3) until scaled residuals of \crefrange{eq:conservationeq_incompressible1}{eq:conservationeq_incompressible6} have reached the convergence limit of \num{e-8}.
\end{enumerate}
...
pos = p,
mincapwidth = 0.9\textwidth,
sideways,
]{lrrrrr}{}{
	\FL
	\multirow{2}{*}{Parameter} 					& \multirow{2}{0.30\linewidth}{Experimental \citep{Kichah2012}} 	& \multicolumn{2}{c}{Numerical} & \multicolumn{2}{c}{$T^{\mathit{num}}-T^{\mathit{exp}}$} \\
